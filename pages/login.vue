  ...
  <div class="m-2">
    <div class="flex flex-col w-60 gap-2 mx-auto mt-40">
      ...
      <div class="flex flex-col">
        <p
          class="text-xs text-red-600 pb-1"
          :class="errorMsg ? 'opacity-100' : 'opacity-0'"
        >
      ...
      <div class="flex flex-col gap-1">
        <button
          class="outline-1 outline-neutral-500 rounded-sm focus:none px-2 py-0.5 hover:bg-indigo-300 hover:text-white hover:cursor-pointer"
          @click="logIn()"
        >
          Log In
        </button>
