  ...
  <div class="flex h-screen">
    ...
    <div class="flex flex-row justify-center h-200 gap-3 m-auto">
      <div class="flex h-fit">
        <div
          class="outline-1 outline-neutral-300 rounded-md flex flex-col justify-center px-2 py-4 font-black text-neutral-700 text-xl"
        >
          <span class="m-auto w-fit -translate-y-0.5">Current</span>
          <span class="mx-auto text-4xl">{{ snake.score }}</span>

          <span class="mx-auto mt-4">Best</span>
          <span class="mx-auto text-3xl">{{ data[0].Score }}</span>
        </div>
      </div>
      <div
